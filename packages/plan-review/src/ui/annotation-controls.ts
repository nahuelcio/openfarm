import type { AnnotationType, AnnotationPosition } from '../types';
import type { AnnotationControlsProps } from './types';
...
export class AnnotationControls {
  ...
  private positionControls(): void {
    ...
    const controls = this.container.querySelector('.annotation-controls') as HTMLElement;
    if (!controls) return;
