...
import type { Annotation, AnnotationFilter, CreateAnnotationRequest, UpdateAnnotationRequest } from '../types';
...
export class AnnotationStorage {
  ...
  findByFilter(filter: AnnotationFilter): Annotation[] {
    ...
    const stmt = this.db.prepare(`SELECT * FROM annotations ${whereClause} ORDER BY createdAt ASC`);
