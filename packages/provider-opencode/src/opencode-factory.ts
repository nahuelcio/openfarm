...
const OpenCodeConfigSchema = {
  ...
  properties: {
    ...
    timeout: { type: 'number', default: 600000, minimum: 1000 },
  },
  required: [],
};
...
export class OpenCodeProviderFactory implements ProviderFactory {
  ...
  private createConfigManager(config: { timeout: number }): ConfigurationManager {
    return createProviderConfigManager('opencode', undefined, { timeout: config.timeout });
  }
}
