 ...
 *
 * Este provider permite integrar agentes CLI externos (Claude, Codex, OpenCode, etc.)
...
export interface ExternalAgentConfig extends ProviderConfig {
	...
	/** CLI a ejecutar (claude, codex, opencode, etc.) */
	cli: string;
...
export class ExternalAgentProvider {
	...
	// Estos tipos hoy viven en el provider externo del SDK.
	 ...
	 *
	 * @param to - Destinatario (ej: "codex:Bob", "frontend:Alice", "*")
