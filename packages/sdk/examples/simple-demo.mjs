 ...
 *
 * Prerequisites:
 * 1. Install @openfarm/sdk
 * 2. Ensure provider CLIs are available (claude/opencode/codex)
 * 3. Configure credentials as needed for specific providers
 */
...
async function demo() {
	...
	console.log("   • Try another provider: opencode or external-agent + codex");
	console.log("");
}
