...
import type { WorkItem, AzureWorkItemFields, AzureWorkItemApiResponse } from "../types";
 ...
 */
export function getAssignedToValue(assignedTo?: AzureWorkItemFields["System.AssignedTo"]): string {
 ...
 */
export function extractAssignee(assignedTo?: AzureWorkItemFields["System.AssignedTo"]) {
 ...
 */
export function mapAzurePriority(azurePriority?: number): "low" | "medium" | "high" | "critical" {
